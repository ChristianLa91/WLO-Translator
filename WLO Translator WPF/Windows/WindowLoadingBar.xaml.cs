...
namespace WLO_Translator_WPF
{
    ...
    public partial class WindowLoadingBar : Window
    {
        ...
        public WindowLoadingBar(string title, string text, string textBeforeValue, double steps,
            RoutedPropertyChangedEventHandler<double> eventHandlerValueChanged, EventHandler eventHandlerLayoutUpdated)
        {
            InitializeComponent();
            ...
            ProgressBar.ValueChanged   += eventHandlerValueChanged;
            ProgressBar.LayoutUpdated  += eventHandlerLayoutUpdated;
        }
